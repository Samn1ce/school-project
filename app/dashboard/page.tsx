        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              {/* Chat Card */}
              <button className="group relative w-full text-left bg-linear-to-br from-green-600 to-emerald-700 rounded-2xl p-6 text-white shadow-lg shadow-green-600/20 overflow-hidden hover:scale-[1.02] transition-transform duration-300">
